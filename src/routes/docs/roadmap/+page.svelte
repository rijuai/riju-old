...
<main class="mx-auto max-w-xl">
	<div class="mb-8">
		...
		<p class="text-muted-foreground">
			We are constantly working on new features and improvements. If you have
			any feature requests just email us at just email us at namaste@riju.ai
		</p>
	</div>
	<div class="flex flex-col gap-4">
		{#each features as { title, description, status }}
			<Card.Root>
				<Card.Header>
