...
<article class="max-w-2xl mx-auto">
	...
	<p>
		...
		Riju's Website, located at https://riju.page.
	</p>

	<p>
		By accessing this website we assume you accept these terms and conditions.
		Do not continue to use Riju if you do not agree to take all of the terms and
	...
	<p>
		...
		Riju shall not be liable for the Comments or for any liability, damages or
	...
	<p>
		...
		compensates the absence of Riju; and (d) the link is in the context of
	...
	<p>
		No use of Riju's logo or other artwork will be allowed for linking absent a
