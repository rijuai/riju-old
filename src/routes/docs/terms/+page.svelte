...
<Card.Root>
	<Card.Header>
		<Card.Title class="text-3xl">Terms and Conditions</Card.Title>
	</Card.Header>
	<Card.Content class="prose">
		...
		<p>
			...
			of Riju's Website, located at https://riju.page.
		</p>

		<p>
			By accessing this website we assume you accept these terms and conditions.
			Do not continue to use Riju if you do not agree to take all of the terms
		...
		<p>
			We employ the use of cookies. By accessing Riju, you agreed to use cookies
			in agreement with the Riju's Privacy Policy.
		</p>
		...
		<p>
			Unless otherwise stated, Riju and/or its licensors own the intellectual
			property rights for all material on Riju. All intellectual property rights
			are reserved. You may access this from Riju for your own personal use
			subjected to restrictions set in these terms and conditions.
		</p>

		<p>You must not:</p>
		<ul>
			<li>Republish material from Riju</li>
			<li>Sell, rent or sub-license material from Riju</li>
			<li>Reproduce, duplicate or copy material from Riju</li>
			<li>Redistribute content from Riju</li>
		</ul>
		...
		<p>
			...
			opinions and information in certain areas of the website. Riju does not
			filter, edit, publish or review Comments prior to their presence on the
			website. Comments do not reflect the views and opinions of Riju,its agents
			...
			laws, Riju shall not be liable for the Comments or for any liability,
		...
		<p>
			Riju reserves the right to monitor all Comments and to remove any Comments
		...
		<p>
			You hereby grant Riju a non-exclusive license to use, reproduce, edit and
		...
		<p>
			...
			hyperlink compensates the absence of Riju; and (d) the link is in the
		...
		<p>
			...
			e-mail to Riju. Please include your name, your organization name, contact
		...
		<p>
			No use of Riju's logo or other artwork will be allowed for linking absent
