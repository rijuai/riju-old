...
<Card.Root class="pros">
    ...
    <Card.Content class="prose">
        <p>
            At Riju, accessible from https://riju.page, one of our main
            priorities is the privacy of our visitors. This Privacy Policy
            document contains types of information that is collected and
            recorded by Riju and how we use it.
        </p>
        ...
        <p>
            ...
            that they shared and/or collect in Riju. This policy is not
        ...
        <p>
            Riju follows a standard procedure of using log files. These files
        ...
        <p>
            Like any other website, Riju uses "cookies". These cookies are used
        ...
        <p>
            ...
            respective advertisements and links that appear on Riju, which are
        ...
        <p>
            Note that Riju has no access to or control over these cookies that
        ...
        <p>
            Riju's Privacy Policy does not apply to other advertisers or
        ...
        <p>
            Riju does not knowingly collect any Personal Identifiable
