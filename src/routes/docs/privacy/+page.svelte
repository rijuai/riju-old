...
<section class="mx-auto max-w-2xl">
	<Card title="Privacy Policy for Riju">
		<p>
			...
			of information that is collected and recorded by Riju and how we use it.
		</p>
		...
		<p>
			Like any other website, Riju uses "cookies". These cookies are used to
		...
		<p>
			...
			advertisements and links that appear on Riju, which are sent directly to
		...
		<p>
			Note that Riju has no access to or control over these cookies that are
		...
		<p>
			Riju's Privacy Policy does not apply to other advertisers or websites.
