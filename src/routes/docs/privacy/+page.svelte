...
<Card title="Privacy Policy for Riju">
	<p>
		...
		information that is collected and recorded by Riju and how we use it.
	</p>
	...
	<p>
		...
		and/or collect in Riju. This policy is not applicable to any information
	...
	<p>
		Riju follows a standard procedure of using log files. These files log
	...
	<p>
		Like any other website, Riju uses "cookies". These cookies are used to store
	...
	<p>
		...
		advertising partners of Riju.
	</p>

	<p>
		Third-party ad servers or ad networks uses technologies like cookies,
		JavaScript, or Web Beacons that are used in their respective advertisements
		and links that appear on Riju, which are sent directly to users' browser.
	...
	<p>
		Note that Riju has no access to or control over these cookies that are used
	...
	<p>
		Riju's Privacy Policy does not apply to other advertisers or websites. Thus,
	...
	<p>
		Riju does not knowingly collect any Personal Identifiable Information from
